#!/usr/bin/env python3
"""Rebuild 1402 technical-question images with adjacent-question context."""
...
PDF = ROOT / "assets/source/arshad_bargh_1402_1251.pdf"
    ...
    with tempfile.TemporaryDirectory() as temp:
        ...
        for page_number, questions in sorted(by_page.items()):
            ...
            if not starts or len(starts) != len(questions):
                raise RuntimeError(
                    f"Could not find all question starts on page {page_number}: {starts}"
                )
